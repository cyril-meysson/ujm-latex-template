...
\usepackage[indent=0.5cm]{parskip} % Alignement et espacement des paragraphes
\usepackage{fancyhdr}
...
\renewcommand*{\intitlepunct\space}{} % Supprime les deux points après in

% Supprime "in" pour les articles uniquement
\renewbibmacro{in:}{%
\ifentrytype{article}
  {}
...
% Support des entrées bibliographiques "standards"
